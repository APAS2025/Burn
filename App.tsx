...
const onboardingSteps: OnboardingStep[] = [
    {
        targetSelector: null,
        title: "Welcome to the Reality Check!",
        content: "This quick tour will show you how to discover the hidden equation behind your food.",
        position: 'center',
    },
    {
        targetSelector: '#add-manual-button',
        title: "1. Add Your Food",
        content: "Start by adding a food item. You can add it manually, search our database, or use your camera with AI.",
        position: 'bottom',
    },
    {
        targetSelector: '.food-input-card-0',
        title: "2. Customize Your Meal",
        content: "Adjust the serving size, calories, and how long it takes to eat. The more accurate, the better!",
        position: 'bottom',
    },
    {
        targetSelector: '#user-input-card',
        title: "3. Personalize the Analysis",
        content: "Enter your weight and select your preferred 'burn' activity to get calculations tailored just for you.",
        position: 'top',
    },
    {
        targetSelector: '#calculate-button-desktop',
        title: "4. See Your Results",
        content: "When you're ready, hit 'Calculate' to see the surprising connection between eating and exercise.",
        position: 'top',
    },
    {
        targetSelector: null,
        title: "You're All Set!",
        content: "Your detailed report will appear on the right. Enjoy discovering the hidden equation!",
        position: 'center',
    }
];
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen font-sans">
      ...
      {/* --- Mobile UI Elements --- */}
      {activeView === 'setup' && (
        <div className="lg:hidden fixed bottom-24 right-4 z-50 animate-pop-in">
          <button
            onClick={handleCalculate}
            disabled={isLoading}
            className="w-16 h-16 flex items-center justify-center gap-3 bg-amber-400 text-zinc-900 font-bold rounded-full shadow-lg shadow-amber-500/20 hover:bg-amber-300 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-110"
            aria-label="Calculate Reality Check"
          >
            {isLoading ? (
